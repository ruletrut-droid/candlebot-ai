...
export default function AIChatPanel({ screenshot }: Props) {
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: 'Olá! Sou seu assistente de trading binário 1M. Posso analisar padrões de velas, sugerir sinais e responder dúvidas sobre estratégias. Se a captura de tela estiver ativa, envie "analisar" para eu interpretar o gráfico atual.' }
  ]);
  ...
  return (
    <div className="terminal-card p-4 flex flex-col h-full">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-sm font-mono font-semibold text-foreground">AI Trading Chat</h3>
      </div>
      ...
      <form onSubmit={e => { e.preventDefault(); sendMessage(); }} className="flex gap-2">
        <Input
          ...
          placeholder="Pergunte sobre trading ou digite 'analisar'..."
